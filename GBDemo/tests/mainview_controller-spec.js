// TESTS for MainViewController

// load app and all frameworks with require
var app = require("../src/js/app");

// Define unit test for controller
describe("MainViewController Tests", function() {

    console.log("Testing MainViewController");
    ...
    describe("Tests - setup", function() {
        ...
        beforeEach(function() {
            ...
            // setup MainViewController and pass it the fake objects
            controller = $controller("MainViewController", {$scope: $scope, Service: customService});

        });

        it("Should load the MainViewController", function(){
